...
let itemDOM = document.querySelector("#itemDiv")
allButton.addEventListener("click", allButtonOnClick)
koreaButton.addEventListener("click", koreaButtonOnClick)
japanButton.addEventListener("click", japanButtonOnClick)
chinaButton.addEventListener("click", chinaButtonOnClick)
